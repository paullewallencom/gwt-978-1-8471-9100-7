...
public class FlickrEditableLabelPanel extends SamplePanel {
	...
	public FlickrEditableLabelPanel() {
		...
		infoPanel
				.add(new HTML(
						"<div class='infoProse'>This example demonstrates the creation of a flickr style editable label. Clicking on the label converts it into a TextBox with a Save and Cancel button at the bottom. You can modify the text and either save your changes or cancel, and it will once again change back to a label.</div>"));
		...
		((SourcesClickEvents) cancelButton)
