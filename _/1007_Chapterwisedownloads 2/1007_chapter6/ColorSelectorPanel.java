...
public class ColorSelectorPanel extends SamplePanel implements KeyboardListener {
	...
	public static SinkInfo init() {
		return new SinkInfo("Color Selector", "Color Selector.") {
	...
	public ColorSelectorPanel() {
		...
		infoPanel
				.add(new HTML(
						"<div class='infoProse'>Select a color by providing the red, green and blue values. The selected color will be applied to the box on the screen and the hex value of the color will be displayed below it with an element sliding up and then sliding down to display the value. Check it out by typing in the color components!</div>"));
