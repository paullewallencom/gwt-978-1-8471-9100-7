...
public class SortableTablesPanel extends SamplePanel {
	...
	public static SinkInfo init() {
		return new SinkInfo("Sortable Tables",
				"Sort Tables by clicking on a column header") {
	...
	public SortableTablesPanel() {
		...
		infoPanel
				.add(new HTML(
						"<div class='infoProse'>This example shows how to create tables whose rows can be sorted by clicking on the column header.</div>"));
